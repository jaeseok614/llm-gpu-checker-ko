...
(() => {
  const catalog = {
    ...
    "core.model.note": { ko: "실행할 모델 기준으로 GPU와 예산 비교", en: "Compare GPUs and budget for one model" },
    ...
    "onboarding.kicker": { ko: "GPU 하나만 고르면 됩니다", en: "Start with one GPU" },
    "onboarding.title": { ko: "내 GPU에서 어떤 AI 모델이 돌아갈까요?", en: "Which AI models run on my GPU?" },
    "onboarding.note": { ko: "실행 가능한 모델, 필요한 양자화, 예상 속도를 같은 기준으로 비교합니다.", en: "Compare runnable models, required quantization, and estimated speed on the same basis." },
    "onboarding.trust": { ko: "서비스 특징", en: "Service characteristics" },
    "onboarding.account": { ko: "회원가입 없음", en: "No account required" },
    "onboarding.local": { ko: "입력값 외부 전송 없음", en: "Inputs stay in your browser" },
    "onboarding.open": { ko: "계산식·데이터 공개", en: "Open formulas and data" },
    "onboarding.search": { ko: "GPU 이름 검색", en: "Search GPU name" },
    "onboarding.quick": { ko: "많이 찾는 GPU", en: "Popular GPUs" },
