...
window.LLM_GPU_CHECKER_DATA.ocrModels = [
  ...
  visionModel({
    ...
    name: "TMElyralab/MuseTalk 1.5",
    maker: "Tencent Music Entertainment",
    params: 1.1,
    license: "MIT",
    tags: ["avatar", "lip-sync", "audio-driven", "realtime", "video"],
    sourceUrl: "https://github.com/TMElyralab/MuseTalk",
    profiles: {
      fp32: { baseRuntimeGb: 3.2, activationGbPerMegapixel: 1.8, batchOverheadGb: 0.8 },
      fp16: { baseRuntimeGb: 2.1, activationGbPerMegapixel: 1.05, batchOverheadGb: 0.5 },
      bf16: { baseRuntimeGb: 2.15, activationGbPerMegapixel: 1.08, batchOverheadGb: 0.52 },
      int8: { baseRuntimeGb: 1.65, activationGbPerMegapixel: 0.82, batchOverheadGb: 0.4 },
    },
    reference: { gpuId: "v100-32", bandwidth: 900, width: 256, height: 256, batch: 1, pagesPerSecond: 30 },
    summary: { ko: "오디오로 입 모양을 구동하는 실시간 립싱크 모델입니다. 공식 저장소는 V100에서 30fps+ 경로를 안내합니다.", en: "A real-time audio-driven lip-sync model whose official repository documents a 30fps+ path on V100." },
  }),
  visionModel({
    type: "avatar-generation",
    name: "KlingAIResearch/LivePortrait",
    maker: "Kuaishou",
    params: 0.9,
    license: "Modified MIT",
    tags: ["avatar", "portrait-animation", "face", "motion-transfer", "video"],
    sourceUrl: "https://github.com/KlingAIResearch/LivePortrait",
    profiles: {
      fp32: { baseRuntimeGb: 2.8, activationGbPerMegapixel: 1.5, batchOverheadGb: 0.7 },
      fp16: { baseRuntimeGb: 1.8, activationGbPerMegapixel: 0.9, batchOverheadGb: 0.45 },
      bf16: { baseRuntimeGb: 1.85, activationGbPerMegapixel: 0.92, batchOverheadGb: 0.46 },
      int8: { baseRuntimeGb: 1.45, activationGbPerMegapixel: 0.7, batchOverheadGb: 0.34 },
    },
    reference: { gpuId: "rtx4090-24", bandwidth: 1008, width: 512, height: 512, batch: 1, pagesPerSecond: 24 },
    summary: { ko: "한 장의 인물 이미지를 모션 입력으로 구동합니다. 코드와 포함된 얼굴 검출 모델의 상업 이용 조건을 별도로 확인해야 합니다.", en: "Animates a portrait from motion input. Commercial deployments must separately review the code and bundled face-detector model terms." },
  }),
  visionModel({
    type: "avatar-generation",
    name: "OpenTalker/SadTalker",
    maker: "OpenTalker",
    params: 0.8,
    license: "Apache 2.0",
    tags: ["avatar", "talking-head", "audio-driven", "single-image", "video"],
    sourceUrl: "https://github.com/OpenTalker/SadTalker",
    profiles: {
      fp32: { baseRuntimeGb: 3.0, activationGbPerMegapixel: 1.65, batchOverheadGb: 0.75 },
      fp16: { baseRuntimeGb: 1.95, activationGbPerMegapixel: 0.98, batchOverheadGb: 0.48 },
      bf16: { baseRuntimeGb: 2.0, activationGbPerMegapixel: 1.0, batchOverheadGb: 0.5 },
      int8: { baseRuntimeGb: 1.55, activationGbPerMegapixel: 0.76, batchOverheadGb: 0.38 },
    },
    reference: { gpuId: "rtx4090-24", bandwidth: 1008, width: 512, height: 512, batch: 1, pagesPerSecond: 12 },
    summary: { ko: "단일 인물 이미지와 음성으로 talking-head 영상을 만드는 모델입니다.", en: "Creates a talking-head video from a single portrait image and driving audio." },
  }),
  visionModel({
    type: "avatar-generation",
    ...
    tags: ["avatar", "lip-sync", "audio-driven", "non-commercial", "video"],
    sourceUrl: "https://github.com/Rudrabha/Wav2Lip",
    profiles: {
      fp32: { baseRuntimeGb: 1.5, activationGbPerMegapixel: 0.8, batchOverheadGb: 0.35 },
      fp16: { baseRuntimeGb: 1.0, activationGbPerMegapixel: 0.48, batchOverheadGb: 0.22 },
      bf16: { baseRuntimeGb: 1.05, activationGbPerMegapixel: 0.5, batchOverheadGb: 0.23 },
      int8: { baseRuntimeGb: 0.8, activationGbPerMegapixel: 0.36, batchOverheadGb: 0.17 },
    },
    reference: { gpuId: "rtx4090-24", bandwidth: 1008, width: 96, height: 96, batch: 1, pagesPerSecond: 30 },
    summary: { ko: "기존 얼굴 영상의 입 모양을 음성과 동기화하는 연구용 모델입니다. 공개 모델은 비상업적 용도로 제한됩니다.", en: "A research lip-sync model for matching mouth motion to audio; its public model is restricted to non-commercial use." },
  }),
];
